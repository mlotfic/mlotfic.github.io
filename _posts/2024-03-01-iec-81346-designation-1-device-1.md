...
title: EPLAN Device Designation `-` Tag System with IEC 81346 and ISA-5.1 and common practice tag naming
description: >-
...
file_name: 2024-03-01-eplan-device-designation-reference-1.md
categories: [EPLAN, Designation, Device, IEC 81346]
...
# EPLAN Device Designation `-` Tag System with IEC 81346 and ISA-5.1 and common practice tag naming

> **Topic:** IEC 81346 and common practice tag naming for device designation (`-`)
...
=SAFE+CP1.SAFE-QF3_ESTOP    Safety relay, in safety section of CP1
```

**Key differences from Function and Location:**

| **Field** | **Purpose** | **Example** |
| :--- | :--- | :--- |
| **Function (`=`)** | Defines the task the device performs | `=PWR`, `=CTRL`, `=INST`, `=SAFE` |
| **Location (`+`)** | Defines where the device is physically located | `+CP1`, `+MCC1`, `+FIELD`, `+PANEL_A` |
| **Device (`-`)** | Identifies the actual component | `-KM1`, `-CPU1`, `-FT101`, `-QF3` |

**Analogy:**
- **Function**: What the device does (e.g., controlling motors)
- **Location**: Where the device is mounted (e.g., Panel A, Motor 1 cubicle)
- **Device**: The physical component itself (e.g., Contactor KM1)
...
-F_OC_A                   Protection device, overcurrent relay, incomer A (descriptive suffix)
...
- **QF** Q: Switching Device, F: protection Device
- **QS** Q: Switching Device, S: Selector Switch `Converts manual operation → signal`
