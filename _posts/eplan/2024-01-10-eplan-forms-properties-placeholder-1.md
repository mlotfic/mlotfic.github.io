...
title: "EPLAN Placeholder Properties Reference"
...
file_name: 2024-03-10-eplan-placeholder-properties-reference-1.md
categories: [EPLAN, Placeholder Properties, Reference]
tags: [EPLAN, placeholder properties, reference]
pin: False
math: true
mermaid: true
comments: true
...
image:
  ...
  alt: EPLAN Placeholder Properties Reference
...
| Using a `Header object` property inside the row   | Same value on every row  | Use `Data object` properties in the row area         |
| Placing placeholder outside the row area          | Not repeated per record  | Move the text element inside the defined row area    |
| Wrong category selected                           | Can't find the property  | Try **All categories** then search by keyword        |
