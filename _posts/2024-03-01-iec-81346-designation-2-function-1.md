...
title: "EPLAN Function Designation (`=`) Reference Guide"

description: >-
  A comprehensive reference guide to the function designation (`=`) scheme in EPLAN Electric P8, including its fundamentals, IEC 81346 standard codes, industry-specific examples, common mistakes, and expert tips for effective implementation in electrical project documentation.
date: 2024-03-10 10:00:00 +0800
author: Mahmoud Lotfi
file_name: 2024-03-10-eplan-function-designation-reference-1.md
categories: [EPLAN, Function Designation, Reference]
tags: [EPLAN, function designation, reference]
pin: False
math: true
mermaid: true
comments: true
...
image:
  ...
  alt: EPLAN Function Designation Explained
...
> **Topic:** IEC 81346 and common practice tag naming for function designation (`=`)  
...
## Table of Contents
- [EPLAN P8 — Function Designation (`=`) Reference Guide](#eplan-p8--function-designation--reference-guide)
  - [Table of Contents](#table-of-contents)
  - [Fundamentals](#fundamentals)
    - [The Three Pillars of EPLAN Referencing (IEC 81346)](#the-three-pillars-of-eplan-referencing-iec-81346)
    - [Structure Syntax](#structure-syntax)
    - [Hierarchy Separator](#hierarchy-separator)
  - [IEC 81346 Standard Letter Codes](#iec-81346-standard-letter-codes)
    - [IEC 81346 Example Set — Pump Station](#iec-81346-example-set--pump-station)
  - [Machine Building](#machine-building)
    - [General Machine](#general-machine)
    - [CNC Machine Specific](#cnc-machine-specific)
    - [Robotic Cell](#robotic-cell)
  - [Panel Building \& OEM](#panel-building--oem)
    - [MCC (Motor Control Centre) Panel](#mcc-motor-control-centre-panel)
    - [Distribution Board](#distribution-board)
  - [Process \& Chemical Industry](#process--chemical-industry)
    - [Within a Unit (e.g. Reaction Unit =U30)](#within-a-unit-eg-reaction-unit-u30)
    - [Utilities](#utilities)
    - [DCS / Instrumentation Split](#dcs--instrumentation-split)
  - [Oil \& Gas](#oil--gas)
  ...
  - [Power Distribution \& Energy](#power-distribution--energy)
    - [HV/MV Substation](#hvmv-substation)
  ...
  - [Pharmaceutical \& Cleanroom](#pharmaceutical--cleanroom)
  ...
  - [Safety \& SIL Systems](#safety--sil-systems)
  - [Full Structure Examples](#full-structure-examples)
    - [Example 1 — Water Pump Station (small project)](#example-1--water-pump-station-small-project)
    - [Example 2 — Manufacturing Cell (multi-level)](#example-2--manufacturing-cell-multi-level)
    - [Example 3 — Substation (IEC 81346 strict)](#example-3--substation-iec-81346-strict)
  - [Common Mistakes](#common-mistakes)
  - [Expert Tips](#expert-tips)
    - [1. Agree with the client before starting](#1-agree-with-the-client-before-starting)
    - [2. Match your `=` structure to the P\&ID or SLD](#2-match-your--structure-to-the-pid-or-sld)
    - [3. Keep it short](#3-keep-it-short)
    - [4. Reserve `=Z` or `=MISC` for exceptions](#4-reserve-z-or-misc-for-exceptions)
    - [5. Create a designation key page](#5-create-a-designation-key-page)
    - [6. Don't create too many top-level designations](#6-dont-create-too-many-top-level-designations)
    - [7. Consider report filtering from day one](#7-consider-report-filtering-from-day-one)
    - [8. Validate with a test page early](#8-validate-with-a-test-page-early)
